...
class UiDialog(object):
    ...
    def item_clicked_1(self):
        ...
        if self.item_1.text() != "Пусто":
            ...
            self.text_role.setGeometry(QtCore.QRect(150, 130, 150, 31))
            self.text_login.setGeometry(QtCore.QRect(150, 160, 150, 31))
            self.text_about_us.setGeometry(QtCore.QRect(150, 190, 150, 31))
